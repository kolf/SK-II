  ...
  PRODUCTS.list.forEach(function(l) {
    ...
    sectionHtml.push(
      '<div class="page-section p-3 p-lg-5 h-100 mx-auto flex-column js-page-block" id="' +
        APP_KEY +
        l.id +
        '" style="background-image: url(../../graphics/img/FTE_image.jpg)"><div class="my-auto"><div class="row"><div class="col-7 offset-5"><div class="bg-white p-lg-5 h-100"><div class="text-center mb-5"><h2 class="text-warning">Facial Treatment Essence</h2><h3>Crystal clear skin after one bottle.</h3></div>' +
        l.content +
        "</div></div></div></div></div>"
    );
